...
class TestCheatEntry(unittest.TestCase):
    def setUp(self):
        self.cheat_entry = CheatEntry(delay_between_cheats_in_seconds=0.25)
        ...
        self.original_open_cheat_prompt = CheatEntry.open_cheat_prompt
        CheatEntry.open_cheat_prompt = MagicMock(name="open_cheat_prompt")
    ...
    def tearDown(self):
        ...
        CheatEntry.open_cheat_prompt = self.original_open_cheat_prompt

    def test_when_open_cheat_prompt_then_should_open_cheat_prompt(self):
        CheatEntry.open_cheat_prompt = self.original_open_cheat_prompt
        self.cheat_entry.open_cheat_prompt()
        ...
        self.assertTrue(self.cheat_entry.is_cheat_prompt_open)
    ...
    def test_when_enter_cheat_given_cheat_prompt_is_open_then_should_enter_cheat_without_opening_cheat_prompt_and_close_cheat_prompt(self):
        self.cheat_entry.is_cheat_prompt_open = True
        self.cheat_entry.enter_cheat("Hello")
        CheatEntry.open_cheat_prompt.assert_not_called()
    ...
    def test_when_enter_cheat_given_cheat_prompt_is_not_open_then_should_open_cheat_prompt_and_enter_cheat_and_close_cheat_prompt(self):
        self.cheat_entry.enter_cheat("Hello")
        CheatEntry.open_cheat_prompt.assert_called()
        self.__assert_sleep_and_keyboard_methods_are_called_and_cheat_entry_prompt_is_closed("Hello")
    ...
    def __assert_sleep_and_keyboard_methods_are_called_and_cheat_entry_prompt_is_closed(self, expected_cheat):
        ...
        self.assertFalse(self.cheat_entry.is_cheat_prompt_open)
